...
- **Seven pin keys, no cap, price doubles per pin** (Paweł, 2026-09-05 evening): background, top, eyes, hair, skin, hair colour, ground; 0.0005 ETH for one, 0.032 ETH for all seven. **Fee split 95/5**: author and the keeper (deployer) wallet that pays gas for reveals and treasury rolls.
- **Everything common or uncommon can be pinned** (Paweł, 2026-09-05 late): all seven layers plus five colours (skin, hair, ground, top, accent); rare and legendary only from luck. Twelve pin keys in a uint128, price doubling per pin, 1.024 ETH for a fully chosen face.
- **No trait edits after the roll in v1** (Paweł, 2026-09-05 late). A rolled face keeps its renderer, seed and pins forever, like the sisters. Re-rolling or buying a different trait, priced by rarity, is an idea for a later season with its own contract; v1 has no hook for it.
