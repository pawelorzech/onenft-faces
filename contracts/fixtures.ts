...
let lucky = 0n; for (let s = 1n; s < 200000n; s++) if (luckyOf(s, ONE_OF_ONES.length) !== undefined) { lucky = s; break; }
if (lucky) cases.push({ seed: lucky, pins: {}, one: luckyOf(lucky, ONE_OF_ONES.length) });
