...
- A roll may pin any of seven things: background, top, eyes, hair or hat, skin tone, hair colour, ground colour. Item pins go to common or uncommon items only (skins: the human tones); colour pins are free of tiers. The price doubles with every pin, 0.0005 ETH for one up to 0.032 for all seven; 95 percent goes to the author and 5 percent to the keeper (deployer) wallet at commit. Pin keys: background, top, eyes, hair, skin, hair colour, ground. Rare and legendary items come only from luck.
